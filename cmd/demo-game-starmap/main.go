// cmd/demo-game-starmap/main.go
// Demo for the starmap data model - displays the local stellar neighborhood.
//
// Usage:
//   go build -o bin/demo-game-starmap ./cmd/demo-game-starmap && bin/demo-game-starmap
//   go run ./cmd/demo-game-starmap --debug
//   go run ./cmd/demo-game-starmap --screenshot 30
//
// Controls:
//   Arrow keys: Pan view
//   +/-: Zoom in/out

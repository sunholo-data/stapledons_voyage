// cmd/demo-game-bridge/main.go
// Demo command for testing the bridge interior view.
// Usage:
//   go run ./cmd/demo-game-bridge                    # Basic bridge view demo
//   go run ./cmd/demo-game-bridge --debug            # Show debug info
//   go run ./cmd/demo-game-bridge --screenshot 30   # Capture frame 30 to out/bridge.png
package main

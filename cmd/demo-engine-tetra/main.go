// cmd/demo-engine-tetra/main.go
// Demo command for testing Tetra3D 3D rendering.
// Usage:
//   go run ./cmd/demo-engine-tetra                     # Basic sphere demo
//   go run ./cmd/demo-engine-tetra --screenshot 60     # Take screenshot after N frames
package main
...
var (
	...
	outputPath      = flag.String("output", "out/demo-engine-tetra.png", "Screenshot output path")
)

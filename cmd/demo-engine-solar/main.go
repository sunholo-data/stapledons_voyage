...
//
// Usage:
//   go run ./cmd/demo-engine-solar                          # Interactive demo
//   go run ./cmd/demo-engine-solar --screenshot 60          # Screenshot after N frames
//   go run ./cmd/demo-engine-solar --mode opaque            # Test opaque background
//   go run ./cmd/demo-engine-solar --mode simple            # Single planet test
//   go run ./cmd/demo-engine-solar --mode cruise            # Animated cruise through solar system
package main

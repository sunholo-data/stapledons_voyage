...
func ship_levels__makeShipLevels(deck *DeckType, trans *TransitionState, glow float64) *ShipLevels {
	return ship_levels__makeShipLevels_impl(deck, trans, glow).(*ShipLevels)
}
...
func ship_levels__deckInfoCore_impl(_unused0 interface{}) interface{} {
...
func getDeckInfo_impl(deck interface{}) interface{} {
	return func() interface{} {
		...
		switch _adt.Kind {
		case DeckTypeKindDeckCore:
			return ship_levels__deckInfoCore_impl(struct{}{})
		case DeckTypeKindDeckEngineering:
			return ship_levels__deckInfoEngineering_impl(struct{}{})
		case DeckTypeKindDeckCulture:
			return ship_levels__deckInfoCulture_impl(struct{}{})
		case DeckTypeKindDeckHabitat:
			return ship_levels__deckInfoHabitat_impl(struct{}{})
		case DeckTypeKindDeckBridge:
			return ship_levels__deckInfoBridge_impl(struct{}{})
		default:
			panic("non-exhaustive match")
		}
	}()
...
func initShipLevels_impl(_unused0 interface{}) interface{} {
	return ship_levels__makeShipLevels_impl(NewDeckTypeDeckBridge(), NewTransitionStateTransitionIdle(), float64(0.5))
}
...
func ship_levels__beginTransition_impl(levels interface{}, target interface{}) interface{} {
	...
	return ship_levels__makeShipLevels_impl(tmp1, tmp3, tmp4)
}

func ship_levels__beginTransition(levels *ShipLevels, target *DeckType) *ShipLevels {
	return ship_levels__beginTransition_impl(levels, target).(*ShipLevels)
}
...
func startDeckTransition_impl(levels interface{}, target interface{}) interface{} {
	...
	return func() interface{} {
		...
		case TransitionStateKindTransitionIdle:
			return ship_levels__beginTransition_impl(levels, target)
...
func ship_levels__finishTransition_impl(levels interface{}, newDeck interface{}) interface{} {
	var tmp6 interface{} = FieldGet(levels, "spireGlow")
	return ship_levels__makeShipLevels_impl(newDeck, NewTransitionStateTransitionIdle(), tmp6)
}

func ship_levels__finishTransition(levels *ShipLevels, newDeck *DeckType) *ShipLevels {
	return ship_levels__finishTransition_impl(levels, newDeck).(*ShipLevels)
}

func ship_levels__continueTransition_impl(levels interface{}, from interface{}, to interface{}, newProgress interface{}) interface{} {
	...
	return ship_levels__makeShipLevels_impl(tmp7, tmp8, tmp9)
}

func ship_levels__continueTransition(levels *ShipLevels, from *DeckType, to *DeckType, newProgress float64) *ShipLevels {
	return ship_levels__continueTransition_impl(levels, from, to, newProgress).(*ShipLevels)
}
	...
	return func() interface{} {
		...
		case TransitionStateKindTransitioning:
			...
			return func() interface{} {
				...
				return func() interface{} {
					if tmp12.(bool) {
						return ship_levels__finishTransition_impl(levels, to)
					}
					return ship_levels__continueTransition_impl(levels, from, to, newProgress)
				}()
			}()
		default:
			panic("non-exhaustive match")

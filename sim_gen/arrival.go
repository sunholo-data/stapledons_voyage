...
func initArrival_impl(_ interface{}) interface{} {
...
func InitArrival(_ *ArrivalPhase) struct{} {
	return initArrival_impl(_).(struct{})
}
...
func IsArrivalComplete(state interface{}) interface{} {
	return isArrivalComplete_impl(state)
}
...
func GetArrivalVelocity(state interface{}) interface{} {
	return getArrivalVelocity_impl(state)
}
...
func GetArrivalPlanetName(state interface{}) interface{} {
	return getArrivalPlanetName_impl(state)
}
...
func GetArrivalPhaseName(state interface{}) interface{} {
	return getArrivalPhaseName_impl(state)
}
...
func GetGRIntensity(state interface{}) interface{} {
	return getGRIntensity_impl(state)
}
...
func calcGRDecay(phase *ArrivalPhase, phaseTime int64, currentGR int64) float64 {
...
func StepArrival(state interface{}, input interface{}) interface{} {
	return stepArrival_impl(state, input)
}
